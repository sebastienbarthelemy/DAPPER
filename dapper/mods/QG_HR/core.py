...
#########################
try:
  from dapper.mods.QG_HR.f90.py_mod import interface_mod as fortran
except ImportError as err:
  raise Exception("Have you compiled the (Fortran) model?" + \
      "\nSee README in folder "+dirs['dapper']+"/mods/QG_HR/f90") from err
...
sample_filename = os.path.join(dirs['samples'],'QG_samples_HR_10000.npz')
